...
import { createBlog, uploadImage } from "../services/api"; // ✅ Import API functions
...
const CreateBlogPage = () => {
  ...
  const [formData, setFormData] = useState({
    title: "",
    category: "",
    author: "SportifyInsider", // ✅ Updated default author
    video_url: "",
    tipAddress: "", // ✅ Ethereum Tip Address
  ...
  const handleSubmit = async (e) => {
    ...
    // ✅ Validate Ethereum tip address format
    if (
      formData.tipAddress &&
